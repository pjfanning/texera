...
public class LinkedBlockingMultiQueueTest extends TestCase {
    ...
    public static LinkedBlockingMultiQueue<QueueKey, Integer> populatedSingleQueue(int n) {
        ...
        LinkedBlockingSubQueue<QueueKey, Integer> sq = q.getSubQueue(QueueKey.A);
    ...
    public static LinkedBlockingMultiQueue<QueueKey, Integer> populatedMultiQueue() {
        ...
        LinkedBlockingSubQueue<QueueKey, Integer> qa = q.getSubQueue(QueueKey.A);
        LinkedBlockingSubQueue<QueueKey, Integer> qb = q.getSubQueue(QueueKey.B);
        LinkedBlockingSubQueue<QueueKey, Integer> qc = q.getSubQueue(QueueKey.C);
        assertTrue(q.isEmpty());
    ...
    public void testOfferNull() {
        ...
        LinkedBlockingSubQueue<QueueKey, ?> sq = q.getSubQueue(QueueKey.A);
        sq.offer(null);
    }
    ...
    public void testTimedPollWithOffer() throws InterruptedException {
        final LinkedBlockingMultiQueue<QueueKey, Integer> q = createSingleQueue();
        final LinkedBlockingSubQueue<QueueKey, Integer> sq = q.getSubQueue(QueueKey.A);
    ...
    public void testTimedPollWithOfferMultiAdded() {
        final LinkedBlockingMultiQueue<QueueKey, Integer> q = createSingleQueue();
        final LinkedBlockingSubQueue<QueueKey, Integer> qa = q.getSubQueue(QueueKey.A);
        final CheckedBarrier barrier = new CheckedBarrier(2);
        final Integer zero = makeElement(0);
        assertTrue(qa.offer(zero));
        qa.enable(false);
        ...
        final LinkedBlockingSubQueue<QueueKey, Integer> qb = q.getSubQueue(QueueKey.B);
    ...
    public void testTimedOffer() {
        ...
        final LinkedBlockingSubQueue<QueueKey, Object> sq = q.getSubQueue(QueueKey.A);
        final CountDownLatch pleaseInterrupt = new CountDownLatch(1);
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() throws InterruptedException {
                sq.put(new Object());
    ...
    public void testNeverContainsNull() {
        ...
        final LinkedBlockingSubQueue<QueueKey, Integer> sq1 = q1.getSubQueue(QueueKey.A);
        ...
        final LinkedBlockingSubQueue<QueueKey, Integer> sq2 = q2.getSubQueue(QueueKey.A);
    ...
    public void testThatTotalSizeMustNotChangeEnablingAlreadyEnabledQueues() {
        ...
        final LinkedBlockingSubQueue<QueueKey, Integer> subQueue = subject.getSubQueue(QueueKey.A);
        subQueue.add(100);
    ...
    void checkEmpty(LinkedBlockingSubQueue<?,?> q) {
        assertTrue(q.isEmpty());
