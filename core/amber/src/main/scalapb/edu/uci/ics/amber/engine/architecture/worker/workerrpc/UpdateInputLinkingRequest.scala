...
final case class UpdateInputLinkingRequest(
    ...
    def companion = edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.architecture.worker.UpdateInputLinkingRequest])
}

object UpdateInputLinkingRequest extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WorkerrpcProto.javaDescriptor.getMessageTypes().get(39)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WorkerrpcProto.scalaDescriptor.messages(39)
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest(
  ...
  implicit class UpdateInputLinkingRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest](_l) {
  ...
  ): _root_.edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest = _root_.edu.uci.ics.amber.engine.architecture.worker.workerrpc.UpdateInputLinkingRequest(
    identifier,
    inputLink
  )
