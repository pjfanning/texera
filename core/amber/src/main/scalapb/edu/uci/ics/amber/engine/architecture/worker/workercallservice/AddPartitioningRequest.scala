...
final case class AddPartitioningRequest(
    ...
    partitioning: edu.uci.ics.amber.engine.architecture.sendsemantics.partitionings.Partitioning = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toCustom(edu.uci.ics.amber.engine.architecture.sendsemantics.partitionings.PartitioningMessage.defaultInstance)
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      {
        val __value = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toBase(partitioning)
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      {
        val __v = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toBase(partitioning)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 2 => {
          val __t = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toBase(partitioning)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toBase(partitioning).toPMessage
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToSingleLineUnicodeString(this)
    def companion = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.architecture.worker.AddPartitioningRequest])
}

object AddPartitioningRequest extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest = {
    ...
    edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest(
        ...
        partitioning = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toCustom(__partitioning.getOrElse(edu.uci.ics.amber.engine.architecture.sendsemantics.partitionings.PartitioningMessage.defaultInstance))
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest(
        ...
        partitioning = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toCustom(__fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[edu.uci.ics.amber.engine.architecture.sendsemantics.partitionings.PartitioningMessage]).getOrElse(edu.uci.ics.amber.engine.architecture.sendsemantics.partitionings.PartitioningMessage.defaultInstance))
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WorkercallserviceProto.javaDescriptor.getMessageTypes().get(40)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WorkercallserviceProto.scalaDescriptor.messages(40)
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest(
    tag = edu.uci.ics.amber.engine.common.virtualidentity.LinkIdentity.defaultInstance,
    partitioning = edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest._typemapper_partitioning.toCustom(edu.uci.ics.amber.engine.architecture.sendsemantics.partitionings.PartitioningMessage.defaultInstance)
  )
  implicit class AddPartitioningRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest](_l) {
  ...
  ): _root_.edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest = _root_.edu.uci.ics.amber.engine.architecture.worker.workercallservice.AddPartitioningRequest(
    tag,
    partitioning
  )
