...
final case class AddPartitioningV2(
    tag: edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink,
    ...
    def withTag(__v: edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink): AddPartitioningV2 = copy(tag = __v)
...
object AddPartitioningV2 extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2 = {
    var __tag: _root_.scala.Option[edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __tag = _root_.scala.Some(__tag.fold(_root_.scalapb.LiteParser.readMessage[edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 18 =>
    ...
    edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2(
        tag = __tag.getOrElse(edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink.defaultInstance),
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2(
        tag = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink]).getOrElse(edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink.defaultInstance),
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2(
    tag = edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink.defaultInstance,
  ...
  implicit class AddPartitioningV2Lens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.controlcommands.AddPartitioningV2](_l) {
    def tag: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink] = field(_.tag)((c_, f_) => c_.copy(tag = f_))
...
final case class UpdateInputLinkingV2(
    ...
    inputLink: edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink
    ...
    def withInputLink(__v: edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink): UpdateInputLinkingV2 = copy(inputLink = __v)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => {
          val __t = identifier
...
object UpdateInputLinkingV2 extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2 = {
    ...
    var __inputLink: _root_.scala.Option[edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink] = _root_.scala.None
    var _done__ = false
    while (!_done__) {
      val _tag__ = _input__.readTag()
      _tag__ match {
        ...
        case 18 =>
          __inputLink = _root_.scala.Some(__inputLink.fold(_root_.scalapb.LiteParser.readMessage[edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag => _input__.skipField(tag)
      }
    }
    edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2(
        ...
        inputLink = __inputLink.getOrElse(edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink.defaultInstance)
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2(
        ...
        inputLink = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink]).getOrElse(edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink.defaultInstance)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 2 => __out = edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2(
    ...
    inputLink = edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink.defaultInstance
  )
  implicit class UpdateInputLinkingV2Lens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.controlcommands.UpdateInputLinkingV2](_l) {
    ...
    def inputLink: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink] = field(_.inputLink)((c_, f_) => c_.copy(inputLink = f_))
  }
...
final case class LinkCompletedV2(
    ...
    def withLinkId(__v: edu.uci.ics.amber.engine.common.virtualidentity.PhysicalLink): LinkCompletedV2 = copy(linkId = __v)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => {
          val __t = linkId
