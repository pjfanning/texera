...
final case class WorkflowFatalError(
    `type`: edu.uci.ics.amber.engine.common.FatalErrorType = edu.uci.ics.amber.engine.common.FatalErrorType.COMPILATION_ERROR,
    ...
    def withType(__v: edu.uci.ics.amber.engine.common.FatalErrorType): WorkflowFatalError = copy(`type` = __v)
    ...
    def companion: edu.uci.ics.amber.engine.common.WorkflowFatalError.type = edu.uci.ics.amber.engine.common.WorkflowFatalError
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.common.WorkflowFatalError])
}

object WorkflowFatalError extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.WorkflowFatalError] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.WorkflowFatalError] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.common.WorkflowFatalError = {
    var __type: edu.uci.ics.amber.engine.common.FatalErrorType = edu.uci.ics.amber.engine.common.FatalErrorType.COMPILATION_ERROR
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 8 =>
          __type = edu.uci.ics.amber.engine.common.FatalErrorType.fromValue(_input__.readEnum())
        case 18 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.common.WorkflowFatalError] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      edu.uci.ics.amber.engine.common.WorkflowFatalError(
        `type` = edu.uci.ics.amber.engine.common.FatalErrorType.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(edu.uci.ics.amber.engine.common.FatalErrorType.COMPILATION_ERROR.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 1 => edu.uci.ics.amber.engine.common.FatalErrorType
    }
  }
  lazy val defaultInstance = edu.uci.ics.amber.engine.common.WorkflowFatalError(
    `type` = edu.uci.ics.amber.engine.common.FatalErrorType.COMPILATION_ERROR,
  ...
  implicit class WorkflowFatalErrorLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.common.WorkflowFatalError]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.common.WorkflowFatalError](_l) {
    def `type`: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.common.FatalErrorType] = field(_.`type`)((c_, f_) => c_.copy(`type` = f_))
  ...
  final val OPERATOR_ID_FIELD_NUMBER = 5
  final val WORKER_ID_FIELD_NUMBER = 6
  def of(
    `type`: edu.uci.ics.amber.engine.common.FatalErrorType,
    timestamp: com.google.protobuf.timestamp.Timestamp,
    message: _root_.scala.Predef.String,
    details: _root_.scala.Predef.String,
    operatorId: _root_.scala.Predef.String,
    workerId: _root_.scala.Predef.String
  ): _root_.edu.uci.ics.amber.engine.common.WorkflowFatalError = _root_.edu.uci.ics.amber.engine.common.WorkflowFatalError(
    `type`,
    timestamp,
    message,
    details,
