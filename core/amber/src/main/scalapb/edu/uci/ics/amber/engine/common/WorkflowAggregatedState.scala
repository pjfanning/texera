...
sealed abstract class WorkflowAggregatedState(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  def companion: _root_.scalapb.GeneratedEnumCompanion[WorkflowAggregatedState] = edu.uci.ics.amber.engine.common.WorkflowAggregatedState
  final def asRecognized: _root_.scala.Option[edu.uci.ics.amber.engine.common.WorkflowAggregatedState.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[edu.uci.ics.amber.engine.common.WorkflowAggregatedState.Recognized])
}
...
object WorkflowAggregatedState extends _root_.scalapb.GeneratedEnumCompanion[WorkflowAggregatedState] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = WorkflowMetricsProto.javaDescriptor.getEnumTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = WorkflowMetricsProto.scalaDescriptor.enums(0)
}