...
final case class LinkOrdinal(
    ...
    def companion = edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.architecture.worker.LinkOrdinal])
}

object LinkOrdinal extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WorkerrpcProto.javaDescriptor.getMessageTypes().get(41)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WorkerrpcProto.scalaDescriptor.messages(41)
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal(
    linkId = edu.uci.ics.amber.engine.common.virtualidentity.LinkIdentity.defaultInstance,
    portOrdinal = 0L
  )
  implicit class LinkOrdinalLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal](_l) {
  ...
  ): _root_.edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal = _root_.edu.uci.ics.amber.engine.architecture.worker.workerrpc.LinkOrdinal(
    linkId,
    portOrdinal
  )
