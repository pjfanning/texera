...
object WorkflowruntimestateProto extends _root_.scalapb.GeneratedFileObject {
  ...
  2ViLk9wZXJhdG9yUnVudGltZVN0YXRzQgriPwcSBXZhbHVlUgV2YWx1ZToCOAEiqwUKEEpvYk1ldGFkYXRhU3RvcmUSUQoFc3Rhd
  ...
  
  G8z"""
      ).mkString)
