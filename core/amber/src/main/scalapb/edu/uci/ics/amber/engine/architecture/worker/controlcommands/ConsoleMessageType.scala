...
object ConsoleMessageType extends _root_.scalapb.GeneratedEnumCompanion[ConsoleMessageType] {
  ...
  @SerialVersionUID(0L)
  case object DEBUGGER extends ConsoleMessageType(0) with ConsoleMessageType.Recognized {
    val index = 0
    val name = "DEBUGGER"
  ...
  @SerialVersionUID(0L)
  case object PRINT extends ConsoleMessageType(1) with ConsoleMessageType.Recognized {
    val index = 1
    val name = "PRINT"
  ...
  @SerialVersionUID(0L)
  case object ERROR extends ConsoleMessageType(2) with ConsoleMessageType.Recognized {
    val index = 2
    val name = "ERROR"
  ...
  @SerialVersionUID(0L)
  case object COMMAND extends ConsoleMessageType(3) with ConsoleMessageType.Recognized {
    val index = 3
    val name = "COMMAND"
  ...
  lazy val values = scala.collection.immutable.Seq(DEBUGGER, PRINT, ERROR, COMMAND)
