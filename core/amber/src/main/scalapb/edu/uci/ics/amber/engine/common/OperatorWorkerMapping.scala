...
final case class OperatorWorkerMapping(
    ...
    def companion: edu.uci.ics.amber.engine.common.OperatorWorkerMapping.type = edu.uci.ics.amber.engine.common.OperatorWorkerMapping
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.common.OperatorWorkerMapping])
}

object OperatorWorkerMapping extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.OperatorWorkerMapping] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.OperatorWorkerMapping] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.common.OperatorWorkerMapping = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.common.OperatorWorkerMapping] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.common.OperatorWorkerMapping(
    operatorId = "",
    workerIds = _root_.scala.Seq.empty
  )
  implicit class OperatorWorkerMappingLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.common.OperatorWorkerMapping]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.common.OperatorWorkerMapping](_l) {
  ...
  final val OPERATOR_ID_FIELD_NUMBER = 1
  final val WORKER_IDS_FIELD_NUMBER = 2
  def of(
    operatorId: _root_.scala.Predef.String,
    workerIds: _root_.scala.Seq[_root_.scala.Predef.String]
  ): _root_.edu.uci.ics.amber.engine.common.OperatorWorkerMapping = _root_.edu.uci.ics.amber.engine.common.OperatorWorkerMapping(
    operatorId,
    workerIds
  )
