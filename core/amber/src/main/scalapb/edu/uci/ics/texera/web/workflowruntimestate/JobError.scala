...
final case class JobError(
    ...
    def withType(__v: edu.uci.ics.texera.web.workflowruntimestate.ErrorType): JobError = copy(`type` = __v)
    def withTimestamp(__v: com.google.protobuf.timestamp.Timestamp): JobError = copy(timestamp = __v)
    ...
    def withWorkerId(__v: _root_.scala.Predef.String): JobError = copy(workerId = __v)
