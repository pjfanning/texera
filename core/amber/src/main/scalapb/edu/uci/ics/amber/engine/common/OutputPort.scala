...
final case class OutputPort(
    ...
    def withId(__v: edu.uci.ics.amber.engine.common.PortIdentity): OutputPort = copy(id = __v)
    ...
    def companion: edu.uci.ics.amber.engine.common.OutputPort.type = edu.uci.ics.amber.engine.common.OutputPort
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.common.OutputPort])
}

object OutputPort extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.OutputPort] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.OutputPort] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.common.OutputPort = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.common.OutputPort] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.common.OutputPort(
    id = edu.uci.ics.amber.engine.common.PortIdentity.defaultInstance,
    displayName = "",
    blocking = false
  )
  implicit class OutputPortLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.common.OutputPort]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.common.OutputPort](_l) {
  ...
  ): _root_.edu.uci.ics.amber.engine.common.OutputPort = _root_.edu.uci.ics.amber.engine.common.OutputPort(
    id,
    displayName,
    blocking
  )
