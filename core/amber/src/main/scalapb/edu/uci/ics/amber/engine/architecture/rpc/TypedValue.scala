...
final case class TypedValue(
    ...
    def companion: edu.uci.ics.amber.engine.architecture.rpc.TypedValue.type = edu.uci.ics.amber.engine.architecture.rpc.TypedValue
    // @@protoc_insertion_point(GeneratedMessage[edu.uci.ics.amber.engine.architecture.rpc.TypedValue])
}

object TypedValue extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.rpc.TypedValue] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.architecture.rpc.TypedValue] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): edu.uci.ics.amber.engine.architecture.rpc.TypedValue = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.architecture.rpc.TypedValue] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = edu.uci.ics.amber.engine.architecture.rpc.TypedValue(
    expression = "",
    valueRef = "",
    valueStr = "",
    valueType = "",
  ...
  implicit class TypedValueLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, edu.uci.ics.amber.engine.architecture.rpc.TypedValue]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, edu.uci.ics.amber.engine.architecture.rpc.TypedValue](_l) {
  ...
  def of(
    ...
    valueType: _root_.scala.Predef.String,
    expandable: _root_.scala.Boolean
  ): _root_.edu.uci.ics.amber.engine.architecture.rpc.TypedValue = _root_.edu.uci.ics.amber.engine.architecture.rpc.TypedValue(
    expression,
    valueRef,
    valueStr,
    valueType,
