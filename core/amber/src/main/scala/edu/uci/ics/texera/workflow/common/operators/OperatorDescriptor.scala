...
import edu.uci.ics.texera.workflow.operators.projection.{ProjectionOpDesc, ProjectionOpDescV2}
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[ProjectionOpDescV2], name = "ProjectionV2"),
