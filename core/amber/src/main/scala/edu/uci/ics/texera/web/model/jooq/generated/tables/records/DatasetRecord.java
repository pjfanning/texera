...
public class DatasetRecord extends UpdatableRecordImpl<DatasetRecord> implements Record6<UInteger, String, Byte, String, String, Timestamp>, IDataset {

    private static final long serialVersionUID = -482057998;
    ...
    @Override
    public Row6<UInteger, String, Byte, String, String, Timestamp> valuesRow() {
    ...
    @Override
    public DatasetRecord values(UInteger value1, String value2, Byte value3, String value4, String value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DatasetRecord(UInteger did, String name, Byte isPublic, String storagePath, String description, Timestamp creationTime) {
        super(Dataset.DATASET);
