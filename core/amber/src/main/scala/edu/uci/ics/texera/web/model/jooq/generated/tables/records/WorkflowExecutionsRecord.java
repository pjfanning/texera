...
public class WorkflowExecutionsRecord extends UpdatableRecordImpl<WorkflowExecutionsRecord> implements Record12<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String, UInteger, String>, IWorkflowExecutions {

    private static final long serialVersionUID = -1893823828;
    ...
    @Override
    public Row12<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String, UInteger, String> fieldsRow() {
        return (Row12) super.fieldsRow();
    }

    @Override
    public Row12<UInteger, UInteger, UInteger, Byte, String, Timestamp, Timestamp, Byte, String, String, UInteger, String> valuesRow() {
    ...
    @Override
    public WorkflowExecutionsRecord value11(UInteger value) {
    ...
    @Override
    public WorkflowExecutionsRecord values(UInteger value1, UInteger value2, UInteger value3, Byte value4, String value5, Timestamp value6, Timestamp value7, Byte value8, String value9, String value10, UInteger value11, String value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowExecutionsRecord(UInteger eid, UInteger vid, UInteger uid, Byte status, String result, Timestamp startingTime, Timestamp lastUpdateTime, Byte bookmarked, String name, String environmentVersion, UInteger environmentEid, String logLocation) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS);
