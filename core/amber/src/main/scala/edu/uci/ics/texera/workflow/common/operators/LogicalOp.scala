...
import edu.uci.ics.texera.workflow.operators.machineLearning.KNNTrainerOpDesc.KNNTrainerOpDescOld
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[KNNTrainerOpDescOld], name = "KNNTrainer"),
