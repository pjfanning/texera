...
import edu.uci.ics.texera.workflow.operators.test.{TestA1OpDesc, TestBOpDesc}
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[TestA1OpDesc], name = "TestA1"),
    new Type(value = classOf[TestA1OpDesc], name = "TestA2"),
