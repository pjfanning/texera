...
class TupleToBatchConverter:
    def __init__(
        ...
        self._partitioners: OrderedDict[PhysicalLinkIdentity, Partitioning] = OrderedDict()
    ...
    def add_partitioning(self, tag: PhysicalLinkIdentity, partitioning: Partitioning) -> None:
        """
