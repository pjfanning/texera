...
# sources: edu/uci/ics/amber/engine/common/actor_message.proto, edu/uci/ics/amber/engine/common/virtual_identity.proto, edu/uci/ics/amber/engine/common/workflow.proto, edu/uci/ics/amber/engine/common/workflow_metrics.proto, edu/uci/ics/amber/engine/common/workflow_runtime_state.proto
...
class ExecutionStatsStore(betterproto.Message):
    start_timestamp: int = betterproto.int64_field(1)
