...
public class WorkflowComputingUnitRecord extends UpdatableRecordImpl<WorkflowComputingUnitRecord> implements Record5<UInteger, String, UInteger, Timestamp, Timestamp>, IWorkflowComputingUnit {

    private static final long serialVersionUID = 486964963;
    ...
    @Override
    public WorkflowComputingUnitRecord value3(UInteger value) {
        setCuid(value);
        return this;
    }
    ...
    @Override
    public WorkflowComputingUnitRecord values(UInteger value1, String value2, UInteger value3, Timestamp value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkflowComputingUnitRecord(UInteger uid, String name, UInteger cuid, Timestamp creationTime, Timestamp terminateTime) {
        super(WorkflowComputingUnit.WORKFLOW_COMPUTING_UNIT);
