package edu.uci.ics.texera.workflow.operators
...
import edu.uci.ics.texera.workflow.common.metadata.{OPVersion, OperatorInfo, PropertyNameConstants}
...
import edu.uci.ics.texera.workflow.operators.machineLearning.sklearnAdvanced.SVRTrainer.SklearnAdvancedSVRTrainerOpDesc
