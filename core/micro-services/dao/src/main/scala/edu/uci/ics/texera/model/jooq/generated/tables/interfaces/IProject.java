...
public interface IProject extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IProject from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IProject
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IProject> E into(E into);
}
