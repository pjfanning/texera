...
public interface IPublicProject extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IPublicProject from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IPublicProject
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IPublicProject> E into(E into);
}
