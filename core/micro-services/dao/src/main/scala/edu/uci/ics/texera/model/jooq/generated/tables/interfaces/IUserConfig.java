...
public interface IUserConfig extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IUserConfig from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IUserConfig
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IUserConfig> E into(E into);
}
