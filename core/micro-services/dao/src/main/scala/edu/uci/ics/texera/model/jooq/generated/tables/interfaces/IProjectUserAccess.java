...
public interface IProjectUserAccess extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IProjectUserAccess from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IProjectUserAccess
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IProjectUserAccess> E into(E into);
}
