...
public interface IWorkflowExecutions extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IWorkflowExecutions from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflowExecutions
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IWorkflowExecutions> E into(E into);
}
