...
public interface IWorkflowOfProject extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IWorkflowOfProject from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflowOfProject
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IWorkflowOfProject> E into(E into);
}
