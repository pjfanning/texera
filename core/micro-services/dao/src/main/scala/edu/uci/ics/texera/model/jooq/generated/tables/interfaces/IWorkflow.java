...
public interface IWorkflow extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IWorkflow from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflow
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IWorkflow> E into(E into);
}
