...
public interface IDatasetVersion extends Serializable {
     ...
     */
    public void from(edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IDatasetVersion from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IDatasetVersion
     */
    public <E extends edu.uci.ics.texera.model.jooq.generated.tables.interfaces.IDatasetVersion> E into(E into);
}
