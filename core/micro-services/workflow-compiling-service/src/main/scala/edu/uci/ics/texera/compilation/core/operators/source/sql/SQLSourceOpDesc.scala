package edu.uci.ics.texera.compilation.core.operators.source.sql

import com.fasterxml.jackson.annotation.{JsonProperty, JsonPropertyDescription}
import com.fasterxml.jackson.databind.annotation.JsonDeserialize
import com.kjetland.jackson.jsonSchema.annotations.{JsonSchemaInject, JsonSchemaTitle}
import edu.uci.ics.amber.core.tuple.{Attribute, AttributeType, Schema}
import edu.uci.ics.texera.compilation.core.common.metadata.annotations.{AutofillAttributeName, BatchByColumn, EnablePresets, UIWidget}
import edu.uci.ics.texera.compilation.core.operators.source.SourceOperatorDescriptor
