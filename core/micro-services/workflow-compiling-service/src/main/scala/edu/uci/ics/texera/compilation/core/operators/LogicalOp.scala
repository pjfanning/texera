...
import edu.uci.ics.texera.compilation.core.common.metadata.{OPVersion, OperatorInfo, PropertyNameConstants}
import edu.uci.ics.texera.compilation.core.operators.aggregate.AggregateOpDesc
import edu.uci.ics.texera.compilation.core.operators.cartesianProduct.CartesianProductOpDesc
import edu.uci.ics.texera.compilation.core.operators.dictionary.DictionaryMatcherOpDesc
import edu.uci.ics.texera.compilation.core.operators.difference.DifferenceOpDesc
import edu.uci.ics.texera.compilation.core.operators.distinct.DistinctOpDesc
import edu.uci.ics.texera.compilation.core.operators.download.BulkDownloaderOpDesc
import edu.uci.ics.texera.compilation.core.operators.dummy.DummyOpDesc
import edu.uci.ics.texera.compilation.core.operators.filter.SpecializedFilterOpDesc
import edu.uci.ics.texera.compilation.core.operators.hashJoin.HashJoinOpDesc
import edu.uci.ics.texera.compilation.core.operators.huggingFace.{HuggingFaceIrisLogisticRegressionOpDesc, HuggingFaceSentimentAnalysisOpDesc, HuggingFaceSpamSMSDetectionOpDesc, HuggingFaceTextSummarizationOpDesc}
import edu.uci.ics.texera.compilation.core.operators.intersect.IntersectOpDesc
import edu.uci.ics.texera.compilation.core.operators.intervalJoin.IntervalJoinOpDesc
import edu.uci.ics.texera.compilation.core.operators.keywordSearch.KeywordSearchOpDesc
import edu.uci.ics.texera.compilation.core.operators.limit.LimitOpDesc
import edu.uci.ics.texera.compilation.core.operators.machineLearning.Scorer.MachineLearningScorerOpDesc
import edu.uci.ics.texera.compilation.core.operators.machineLearning.sklearnAdvanced.KNNTrainer.{SklearnAdvancedKNNClassifierTrainerOpDesc, SklearnAdvancedKNNRegressorTrainerOpDesc}
import edu.uci.ics.texera.compilation.core.operators.machineLearning.sklearnAdvanced.SVCTrainer.SklearnAdvancedSVCTrainerOpDesc
import edu.uci.ics.texera.compilation.core.operators.machineLearning.sklearnAdvanced.SVRTrainer.SklearnAdvancedSVRTrainerOpDesc
import edu.uci.ics.texera.compilation.core.operators.projection.ProjectionOpDesc
import edu.uci.ics.texera.compilation.core.operators.randomksampling.RandomKSamplingOpDesc
import edu.uci.ics.texera.compilation.core.operators.regex.RegexOpDesc
import edu.uci.ics.texera.compilation.core.operators.reservoirsampling.ReservoirSamplingOpDesc
import edu.uci.ics.texera.compilation.core.operators.sentiment.SentimentAnalysisOpDesc
import edu.uci.ics.texera.compilation.core.operators.sink.managed.ProgressiveSinkOpDesc
import edu.uci.ics.texera.compilation.core.operators.sklearn.{SklearnAdaptiveBoostingOpDesc, SklearnBaggingOpDesc, SklearnBernoulliNaiveBayesOpDesc, SklearnComplementNaiveBayesOpDesc, SklearnDecisionTreeOpDesc, SklearnDummyClassifierOpDesc, SklearnExtraTreeOpDesc, SklearnExtraTreesOpDesc, SklearnGaussianNaiveBayesOpDesc, SklearnGradientBoostingOpDesc, SklearnKNNOpDesc, SklearnLinearRegressionOpDesc, SklearnLinearSVMOpDesc, SklearnLogisticRegressionCVOpDesc, SklearnLogisticRegressionOpDesc, SklearnMultiLayerPerceptronOpDesc, SklearnMultinomialNaiveBayesOpDesc, SklearnNearestCentroidOpDesc, SklearnPassiveAggressiveOpDesc, SklearnPerceptronOpDesc, SklearnPredictionOpDesc, SklearnProbabilityCalibrationOpDesc, SklearnRandomForestOpDesc, SklearnRidgeCVOpDesc, SklearnRidgeOpDesc, SklearnSDGOpDesc, SklearnSVMOpDesc}
import edu.uci.ics.texera.compilation.core.operators.sort.SortOpDesc
import edu.uci.ics.texera.compilation.core.operators.sortPartitions.SortPartitionsOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.apis.reddit.RedditSearchSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.apis.twitter.v2.{TwitterFullArchiveSearchSourceOpDesc, TwitterSearchSourceOpDesc}
import edu.uci.ics.texera.compilation.core.operators.source.fetcher.URLFetcherOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.scan.FileScanSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.scan.csv.CSVScanSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.scan.csvOld.CSVOldScanSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.scan.json.JSONLScanSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.scan.text.TextInputSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.sql.asterixdb.AsterixDBSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.sql.mysql.MySQLSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.sql.postgresql.PostgreSQLSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.split.SplitOpDesc
import edu.uci.ics.texera.compilation.core.operators.symmetricDifference.SymmetricDifferenceOpDesc
import edu.uci.ics.texera.compilation.core.operators.typecasting.TypeCastingOpDesc
import edu.uci.ics.texera.compilation.core.operators.udf.java.JavaUDFOpDesc
import edu.uci.ics.texera.compilation.core.operators.udf.python.source.PythonUDFSourceOpDescV2
import edu.uci.ics.texera.compilation.core.operators.udf.python.{DualInputPortsPythonUDFOpDescV2, PythonLambdaFunctionOpDesc, PythonTableReducerOpDesc, PythonUDFOpDescV2}
import edu.uci.ics.texera.compilation.core.operators.udf.r.{RUDFOpDesc, RUDFSourceOpDesc}
import edu.uci.ics.texera.compilation.core.operators.union.UnionOpDesc
import edu.uci.ics.texera.compilation.core.operators.unneststring.UnnestStringOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.DotPlot.DotPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.IcicleChart.IcicleChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.ImageViz.ImageVisualizerOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.ScatterMatrixChart.ScatterMatrixChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.barChart.BarChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.boxPlot.BoxPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.bubbleChart.BubbleChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.candlestickChart.CandlestickChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.continuousErrorBands.ContinuousErrorBandsOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.contourPlot.ContourPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.dumbbellPlot.DumbbellPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.figureFactoryTable.FigureFactoryTableOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.filledAreaPlot.FilledAreaPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.funnelPlot.FunnelPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.ganttChart.GanttChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.heatMap.HeatMapOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.hierarchychart.HierarchyChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.histogram.HistogramChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.htmlviz.HtmlVizOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.lineChart.LineChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.pieChart.PieChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.quiverPlot.QuiverPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.sankeyDiagram.SankeyDiagramOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.scatter3DChart.Scatter3dChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.scatterplot.ScatterplotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.tablesChart.TablesPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.ternaryPlot.TernaryPlotOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.urlviz.UrlVizOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.waterfallChart.WaterfallChartOpDesc
import edu.uci.ics.texera.compilation.core.operators.visualization.wordCloud.WordCloudOpDesc
