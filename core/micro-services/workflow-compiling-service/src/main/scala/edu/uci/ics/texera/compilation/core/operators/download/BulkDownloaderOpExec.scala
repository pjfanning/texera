package edu.uci.ics.texera.compilation.core.operators.download

import edu.uci.ics.amber.core.executor.OperatorExecutor
import edu.uci.ics.amber.core.tuple.{Tuple, TupleLike}
import edu.uci.ics.amber.core.workflow.WorkflowContext
import edu.uci.ics.texera.compilation.core.operators.source.fetcher.URLFetchUtil.getInputStreamFromURL
