package edu.uci.ics.texera.compilation.core.operators.visualization.ScatterMatrixChart
...
import edu.uci.ics.texera.compilation.core.common.metadata.annotations.{AutofillAttributeName, AutofillAttributeNameList}
import edu.uci.ics.texera.compilation.core.operators.PythonOperatorDescriptor
import edu.uci.ics.texera.compilation.core.operators.visualization.{VisualizationConstants, VisualizationOperator}
