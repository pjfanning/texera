package edu.uci.ics.texera.compilation.core.operators.hashJoin
...
import edu.uci.ics.texera.compilation.core.common.metadata.annotations.{AutofillAttributeName, AutofillAttributeNameOnPort1}
import edu.uci.ics.texera.compilation.core.operators.LogicalOp
import edu.uci.ics.texera.compilation.core.operators.hashJoin.HashJoinOpDesc.HASH_JOIN_INTERNAL_KEY_NAME
