package edu.uci.ics.texera.compilation.core.operators.source.sql.postgresql
...
import edu.uci.ics.texera.compilation.core.common.metadata.annotations.UIWidget
import edu.uci.ics.texera.compilation.core.operators.source.sql.SQLSourceOpDesc
import edu.uci.ics.texera.compilation.core.operators.source.sql.postgresql.PostgreSQLConnUtil.connect
