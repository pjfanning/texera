...
export const CLOSE_WORKFLOW_EXECUTION_REPLAY = "close_workflow_execution_replay";
...
export class ReplayWorkflowService {
  ...
  public closeReplayPanel(): void {
    this.displayWorkflowReplay.next(CLOSE_WORKFLOW_EXECUTION_REPLAY);
  }
  ...
  public selectReplayPoint(key: number): void {
    ...
    //     this.replayTime = 0;
    //     this.workflowWebsocketService.send("WorkflowReplayRequest", {replayPos: key, plannerStrategy: "", replayTimeLimit: 0});
