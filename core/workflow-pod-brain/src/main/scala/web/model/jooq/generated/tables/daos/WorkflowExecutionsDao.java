...
public class WorkflowExecutionsDao extends DAOImpl<WorkflowExecutionsRecord, web.model.jooq.generated.tables.pojos.WorkflowExecutions, UInteger> {

    /**
     * Create a new WorkflowExecutionsDao without any configuration
     */
    public WorkflowExecutionsDao() {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS, web.model.jooq.generated.tables.pojos.WorkflowExecutions.class);
    }
    ...
    public WorkflowExecutionsDao(Configuration configuration) {
        super(WorkflowExecutions.WORKFLOW_EXECUTIONS, web.model.jooq.generated.tables.pojos.WorkflowExecutions.class, configuration);
    }

    @Override
    public UInteger getId(web.model.jooq.generated.tables.pojos.WorkflowExecutions object) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfEid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByEid(UInteger... values) {
     ...
     */
    public web.model.jooq.generated.tables.pojos.WorkflowExecutions fetchOneByEid(UInteger value) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfVid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByVid(UInteger... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfUid(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByUid(UInteger... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfStatus(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByStatus(Byte... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfResult(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByResult(String... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfStartingTime(Timestamp lowerInclusive, Timestamp upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByStartingTime(Timestamp... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfLastUpdateTime(Timestamp lowerInclusive, Timestamp upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByLastUpdateTime(Timestamp... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfBookmarked(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByBookmarked(Byte... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByName(String... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfEnvironmentVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByEnvironmentVersion(String... values) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchRangeOfLogLocation(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<web.model.jooq.generated.tables.pojos.WorkflowExecutions> fetchByLogLocation(String... values) {
