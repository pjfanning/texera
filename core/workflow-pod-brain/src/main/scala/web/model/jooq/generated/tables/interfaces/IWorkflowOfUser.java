...
public interface IWorkflowOfUser extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IWorkflowOfUser from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflowOfUser
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IWorkflowOfUser> E into(E into);
}
