...
public interface IDatasetUserAccess extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IDatasetUserAccess from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IDatasetUserAccess
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IDatasetUserAccess> E into(E into);
}
