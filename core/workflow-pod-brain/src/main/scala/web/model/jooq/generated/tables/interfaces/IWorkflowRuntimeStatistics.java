...
public interface IWorkflowRuntimeStatistics extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IWorkflowRuntimeStatistics from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflowRuntimeStatistics
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IWorkflowRuntimeStatistics> E into(E into);
}
