...
public interface IWorkflowExecutions extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IWorkflowExecutions from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflowExecutions
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IWorkflowExecutions> E into(E into);
}
