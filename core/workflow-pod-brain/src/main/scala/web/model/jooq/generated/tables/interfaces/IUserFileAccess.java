...
public interface IUserFileAccess extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IUserFileAccess from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IUserFileAccess
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IUserFileAccess> E into(E into);
}
