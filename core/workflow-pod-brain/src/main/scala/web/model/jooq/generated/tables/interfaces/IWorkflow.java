...
public interface IWorkflow extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IWorkflow from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IWorkflow
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IWorkflow> E into(E into);
}
