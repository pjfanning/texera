...
public interface IDataset extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IDataset from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IDataset
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IDataset> E into(E into);
}
