...
public interface IProject extends Serializable {
     ...
     */
    public void from(web.model.jooq.generated.tables.interfaces.IProject from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IProject
     */
    public <E extends web.model.jooq.generated.tables.interfaces.IProject> E into(E into);
}
